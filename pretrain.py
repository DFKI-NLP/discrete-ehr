...
def parse_arguments():
    ...
    parser.add_argument('--sampler', default='samplers.DiagnoseAgeSubjectRandomSampler')
    ...
    parser.add_argument('--cyclical_lr', nargs=2, default=(5e-4, 5e-3), type=float,
                        help='tuple of lr base and max.')
    parser.add_argument('--batch_update', default=64, type=int)
    parser.add_argument('--batch_size', default=1, type=int)
    parser.add_argument('--patience', default=8, type=int)
    parser.add_argument('--tasks', nargs='+', default=['contr'],
                        help='list of tasks from contr pred')
    parser.add_argument('--loss_weight_contr', default=1., type=float,
                        help='loss weigt for multitask learning.')

    # Model
    parser.add_argument('--modelcls', default='models.MomentumContrastiveModel')
    ...
    parser.add_argument('--freeze_encoders', default=False,
                        type=eval, choices=[True, False])
    parser.add_argument('--prediction_steps', nargs='+', default=[1], type=int)
    parser.add_argument('--K', default=50000, type=int)
    parser.add_argument('--momentum', default=0.999, type=float)
    parser.add_argument('--temperature', default=0.1, type=float)
    parser.add_argument('--cossim', default=False, action='store_true')
    parser.add_argument('--predictor_mlp', default=True,
                        type=eval, choices=[True, False])
    parser.add_argument('--predictor', default=True,
                        type=eval, choices=[True, False])
    ...
    parser.add_argument('--normalize_mlp', default=False,
                        type=eval, choices=[True, False])
    parser.add_argument('--sep_bin', default=False, action='store_true')
    ...
    parser.add_argument('--include_source', default=False, type=eval,
                        choices=[True, False])
    ...
    parser.add_argument('--event_dropout', default=.2, type=float)
    parser.add_argument('--input_dropout', default=0.1, type=float)
    parser.add_argument('--visit_dropout', default=0.1, type=float)
    parser.add_argument('--decision_dropout', default=0.1, type=float)
